...
namespace UnityEngine.EventSystems {
	...
	public class PinchInputDetector : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler {
		...
		private bool touchWasPartOfPinch = false;
    ...
    [SerializeField] protected UnityEvent onAllFingersReleased;
    ...
    protected virtual void Awake() {
		...
		protected virtual void UnregisterPointer(PointerEventData eventData) {
			...
			if (touchCount == 0 && touchWasPartOfPinch) {
				touchWasPartOfPinch = false;
				onAllFingersReleased?.Invoke();
      }
		}
